...
class Dana_lain_model extends CI_Model {
    
    private $table = 'pengajuan'; // Use the new table name
    private $document_table = 'dokumen'; // New document table
    ...
    public function get_all() {
        ...
        $this->db->where('p.jenis_pengajuan', 'dana_lain'); // Assuming jenis_pengajuan is still relevant
