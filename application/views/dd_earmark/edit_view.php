...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1>EDIT DD EARMARK</h1>
    <a href="<?php echo base_url('dd_earmark'); ?>" class="btn btn-light btn-sm">
        <i class="fas fa-arrow-left"></i> Kembali
    </a>
</div>

<?php echo form_open_multipart('dd_earmark/edit/'.$pengajuan->id); ?>
...
<div class="file-list mt-4">
    ...
    <div class="file-item">
        ...
        <?php if($current_file): ?>
        <a href="<?php echo base_url('uploads/dokumen_dd_earmark/'.$current_file->nama_file); ?>" target="_blank" class="btn btn-info btn-sm preview-btn">
