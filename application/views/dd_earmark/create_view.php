...
<h1>TAMBAH DD EARMARK</h1>

<?php echo form_open_multipart('dd_earmark/create'); ?>
...
<div class="file-list mt-4">
    ...
    <div class="file-item">
        ...
        <div class="custom-file">
            <input type="file" class="custom-file-input" id="<?php echo $jenis; ?>" name="<?php echo $jenis; ?>" required>
            <label class="custom-file-label" for="<?php echo $jenis; ?>">Pilih File</label>
        </div>
...
<div class="button-group mt-4">
    ...
    <a href="<?php echo base_url('dd_earmark'); ?>" class="btn btn-light btn-sm ms-2">
...
$('#kecamatan_id').on('change', function() {
    ...
    if(kecamatanId) {
        $.ajax({
            url: '<?php echo base_url("dd_earmark/get_desa_by_kecamatan/"); ?>' + kecamatanId,
            type: 'GET',
            dataType: 'json',
...
$('#desa_id').on('change', function() {
    ...
    if(desaId) {
        $.ajax({
            url: '<?php echo base_url("dd_earmark/get_desa_details/"); ?>' + desaId,
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                if(!data.error) {
