...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1>EDIT DANA LAIN</h1>
    <a href="<?php echo base_url('dana_lain'); ?>" class="btn btn-light btn-sm">
        <i class="fas fa-arrow-left"></i> Kembali
    </a>
</div>

<?php echo form_open_multipart('dana_lain/edit/'.$pengajuan->id); ?>
...
<div class="file-list mt-4">
    ...
    <div class="file-item">
        ...
        <?php if($current_file): ?>
        <a href="<?php echo base_url('uploads/dokumen_lain/'.$current_file->nama_file); ?>" target="_blank" class="btn btn-info btn-sm preview-btn">
